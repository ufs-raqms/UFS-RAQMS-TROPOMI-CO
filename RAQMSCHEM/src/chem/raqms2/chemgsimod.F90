...
!  use raqmschem_model_mod, only : chem_model_get => raqmschem_model_get
  ...
  use raqmschem_pmgrid_mod, only : forecast_hr,ompsgsi,raqms_localIOflag
  use raqmschem_pmgrid_mod, only : gsiarray,masterproct
...
!            fix 2/25/2021
    ...
    call raqmschem_comm_all_bcast_tile(exist,rc=localrc)
