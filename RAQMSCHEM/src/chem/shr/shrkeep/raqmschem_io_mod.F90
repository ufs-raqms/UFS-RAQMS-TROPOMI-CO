...
!    call flush(6)
  ...
  subroutine raqmsbigchem_io_file_read(datafile, buffer, recrange, recsize, recstride, rc)
...
!      call flush(72+mype)
  ...
  end subroutine raqmsbigchem_io_file_read
...
!     call flush(6)
      if(present(bigendian))then
        call raqmsbigchem_io_file_read(datafile, buffer, recrange=recrange, recsize=recsize, recstride=recstride, rc=localrc)
      else
