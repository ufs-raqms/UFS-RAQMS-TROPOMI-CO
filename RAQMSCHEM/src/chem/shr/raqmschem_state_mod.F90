module raqmschem_state_mod
  ...
  type chem_state_type
    ...
    real(CHEM_KIND_R8), dimension(:,:),     pointer :: cmdrag   => null()
    real(CHEM_KIND_R8), dimension(:,:),     pointer :: cktop_kbot_cnv   => null()
    real(CHEM_KIND_R8), dimension(:,:,:),   pointer :: cldtau  => null()
    real(CHEM_KIND_R8), dimension(:,:,:),   pointer :: vort  => null()
...
end module raqmschem_state_mod
