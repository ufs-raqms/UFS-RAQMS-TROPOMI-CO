...
!          write(500+iam,*)'imm',imm,'burn',burnt_area,'frp',frp,'iveg',iveg_ag
        ...
        entry=entry+1
!        write(500+iam,*)iat,jat,'k2',k2,'k1',k1,'dzi',dzi,zzcon(k2+1),zzcon(k1)
!        write(500+iam,*)'ztopmax',ztopmax
!        call flush(500+iam)
!        if(entry<100)then
!          write(300+iam,*)'k2',k2,'k1',k1,'dzi',dzi,'zzcon',zzcon(k2+1),zzcon(k1),'nspec',nspecies
!          call flush(300+iam)
!        endif
!        if(k1<k2)then
...
!     ramp for 5 minutes
 ...
 ELSE
    ...
    ENDIF
 ENDIF
! write(500+iam,*)'heating',iat,jat,heating
...
!      ------------------------------------------------------------------------
end module raq_plume_scalar_mod
