...
!  integer, parameter :: importFieldCount = 29
...
!    write(6,*)'raqmschenm_backgd_read',mype
!    call flush(6)
    call raqmschem_backgd_read(yy,mm,dd,bigendian=bigendian,rc=rc)
!    write(6,*)'did raqmschenm_backgd_read',mype
!    call flush(6)
...
!    call flush(6)
  ...
  subroutine raqModelAdvance(model, rc)
    ...
    ! query the Component for its clock, importState and exportState
!     write(6,*)'ajl top raqmschem modeladvance 8.8'
...
!    call flush(0)
    ...
    call chem_comm_get(localpe=mype)
!    write(200+mype,*)'ajl top raqs adv'
!    call flush(200+mype)
    if(mype.eq.0)then 
...
#endif
!  write(6,*)'ajl bottom raqms modeladvance 8.8'
!  call flush(6)
!    write(200+mype,*)'ajl bot raqs adv'
!    call flush(200+mype)
