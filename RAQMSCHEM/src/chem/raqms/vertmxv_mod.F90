...
!-----------------------------------------------------------------------
    SUBROUTINE vertmxv( dt, ntrac,phiv, kt_turb, dryrho,  &
...
! .. Scalar Arguments ..
      INTEGER, INTENT(IN) :: kts,ktem1,ntrac
...
! .. Array Arguments ..
      ...
      REAL, INTENT(INOUT), DIMENSION (kts:ktem1,ntrac) :: phiv
      REAL,  DIMENSION (kts:ktem1) :: phi
! ..
! .. Local Scalars ..
      INTEGER :: k,m
! ..
