subroutine calcaodgsi(tr3d,dzaod,data,nchem,ids,ide,jds,jde,nl,pri3d,prl3d,tk3d,de)
  ...
  use raqmschem_const_mod, only : epsqs,rd,grvity
...
!  end do
!    write(300+iam,*)'daod',n,caod(n),maxval(data%aodg5)
!    write(300+iam,*)'kecrtmmax',kecrtmmax(n)
!  end do
!  write(6,*)'boottom calcaodgsi',maxval(data%aodg5),minval(data%aodg5)
!  call flush(6)
...
character *256 file
!write(600+iam,*)'top readkecrtmhr'
!call flush(600+iam)
file='/home/lenzen/GSI/ke.gocart.geos5.nc'
...
!  write(600+iam,*)'kecrtmrh',maxval(kecrtmrh)
!  call flush(600+iam)
endif
!do k=0,maxrhdim
!  write(600+iam,*)'kecrtmrh',k,kecrtmrh(k,:)
!  call flush(600+iam)
!end do
