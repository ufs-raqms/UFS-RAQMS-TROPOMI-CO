...
mkdir -p $DATAINC
echo made $DATAINC >& $BASE_OUT/gsiout.test 
export CASE=C192
...
export base_data_disk_tropomico=/ships19/aqda/mbruckner/FV3GFSCO_TROPOMI/OBS
$GSI_DIR/run/run_gsi_TROPOMI.CO.ak.blended.ksh >& $GSI_SCRATCH/outgsi.TROPOMI.CO.$CDATEF
