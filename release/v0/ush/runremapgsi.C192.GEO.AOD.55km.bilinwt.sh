...
#/home/lenzen/UTILS/fv32ll.x >& $GSI_SCRATCH/out.$CDATE.outfv32ll
export CDATEF=$CDATE
export DATAFV3IN=$DATAREGRID
export PATHLL=$DATAREGRID
#sleep 2 # to stop failure
# looks like 2 seconds is not long enough
sleep 5 # to stop failure
sleep 10 # to stop failure
#srun -O --mem=6G  -n 1 /home/lenzen/UTILS/fv32ll.gen.gen.deflate.bilinwt.x >& $gsi_scratch/out.$CDATE.outfv32ll.deflate.bilinwt
