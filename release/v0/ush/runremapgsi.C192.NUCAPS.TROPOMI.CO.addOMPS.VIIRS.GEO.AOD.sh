...
export CDATEF=$CDATE
export HH=`echo $CDATEF | cut -c9-10`
export HH=3$HH
export HH3=$((HH % 3))
echo HH $HH HH3 $HH3
...
export base_data_disk_OMPS_OZONE=/ships19/aqda/lenzen/OMPS-NPP/2019/
$GSI_DIR/run/run_gsi_FV3GFS.OMPS.OZONE.ksh  >& $GSI_SCRATCH/outgsi.OMPS.OZONE.$CDATEF
# need to do outside of script above
# add VIIRS AOD now
export base_data_disk_viirs_aod=/ships19/aqda/lenzen/VIIRS.NC/
