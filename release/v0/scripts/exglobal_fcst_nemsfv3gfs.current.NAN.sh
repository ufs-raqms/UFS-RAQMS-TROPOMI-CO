...
&chem_nml
  ...
  archive_step =-1
  chem_hist_outname = "chem_out_"
  emi_inname  = "/ships19/aqda/lenzen/CEDS_2019/GEFS-Aerosol_emissions/emi_${CASE}NAN/$SMONTH"
  dust_inname = "/ships19/aqda/lenzen/CEDS_2019/GEFS-Aerosol_emissions/emi_${CASE}NAN/fengsha/$SMONTH"
  fireemi_inname  = "GBBEPx"
  emi_outname = "./"
  $chem_nml
/
