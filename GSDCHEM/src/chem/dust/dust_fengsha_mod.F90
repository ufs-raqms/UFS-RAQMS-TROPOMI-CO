    ...
    do j=jts,jte
       do i=its,ite
          ...
          if(xland(i,j).lt.1.5)then
             ...
             ustar(1,1)=ust(i,j)
             dxy(1)=area(i,j)
!             if(isnan(clay(i,j)))then
!               write(6,*)'clay nan',i,j,clay(i,j),sand(i,j)
!             endif
...
!             if(isnan(clay(i,j)).and.ilwi(1,1)==0)then
!               write(6,*)'cycle nan',i,j
!               call flush(6)
!             endif
             if(ilwi(1,1) == 0 ) cycle
!             if(isnan(clay(i,j)))then
!                write(6,*)'**** clay nan',i,j,'rdrag',rdrag(i,j)
               !call flush(6)
!             endif
             ...
             if (dust_calcdrag .ne. 1) then
                ...
                if (rdrag(i,j) > 0.) then
                  ...
                  if(isnan(clay(i,j)))then
                    write(6,*)'rdrag clay nan',i,j,rdrag(i,j),clay(i,j)
                  endif
                  cycle
                endif
             endif
             ...
             if(isnan(clay(i,j)))then
               write(6,*)'clay nan',i,j,clay(i,j),sand(i,j),'massfrac',massfrac
             endif
...
!    write(6,*)'smx',smx,'massfrac',massfrac(1)
!       call flush(6)
    DO n=1,smx
       dmass=massfrac(spoint(n))*frac_salt(n)
!       write(6,*)'massgrac',n,spoint(n),massfrac(spoint(n))
!       call flush(6)
    ...
    DO n=1,smx
       ...
       if(isnan(stotal))then
         write(6,*)'ds_rel',n,ds_rel(n),'dsurface',dsurface(n),stotal
       endif
    ENDDO
